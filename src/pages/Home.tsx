        ...
        <div className="border-gray-300 rounded-lg min-w-full md:min-w-[650px] lg:min-w-[1024px]">
          <div className="flex items-center">
            <input
              ...
              placeholder="Search..."
              className={clsx("flex-1 p-2 border border-gray-300", searchQuery ? "rounded-l-lg" : "rounded-lg")}
            />
            {searchQuery && (
              <button onClick={handleClear} className="p-2 hover:bg-gray-300 border border-l-0 rounded-r-lg border-gray-300">
                <LuXCircle size={24}  />
              </button>
            )}
            <button onClick={handleExpandCollapse} className="ml-2 p-2 bg-blue-800 hover:bg-blue-950 border border-gray-300 rounded-lg">
